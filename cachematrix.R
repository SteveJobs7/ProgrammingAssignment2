...
## itself, the inverse matrix, and the functions to read and write the inverse. 
## The inverse can be calculated using the functon cacheSolve
...
## it's inverse (initially set to NULL), and can also read and write the matrix itself
